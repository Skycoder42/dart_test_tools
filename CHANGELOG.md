...
## [7.3.2] - 2026-08-28
### Fixed
- `auto-update`: Run build\_runner before applying formatting and auto-fixes when updating

## [7.3.1] - 2026-08-25
### Fixed
- code\_gen: `ConstantReader.toExpression` can now convert collection, `Type` and `Symbol` constants

## [7.3.0] - 2026-08-14
### Changed
- `auto-update`: Automatically try to apply formatting and auto-fixes when updating
...
## [7.2.6] - 2026-07-01
### Added
- Added analyzer plugin updates to automatic updates

## [7.2.5] - 2026-06-30
### Fixed
- Fix version constraint on automatic dependency updates
- Correctly handle packages without version or changelog
...
## [7.2.2] - 2026-05-16
### Fixed
- Fixed missing workspace for cider invocations in auto update

## [7.2.1] - 2026-05-09
### Fixed
- Fixed missing handling for record and function types in reference conversion

## [7.2.0] - 2026-05-03
### Added
- Added new `code_gen` library with common helpers for dart code generation
...
## [7.1.1] - 2026-04-22
### Fixed
- Install powershell for AUR build
- Invoke global tools directly

## [7.1.0] - 2026-04-15
### Changed
- Updated dependencies
- Refactor dart binary handling for workflows and tools
...
## [7.0.1] - 2025-11-22
### Fixed
- Promoted `lints` and `flutter_lints` to normal dependencies to, as they are
now referenced directly by the analysis options.
...
### Changed
- Updated dependencies
  - refactored models to be compatible with freezed 3.0
- Updated linter rules with newer lint base package

## [6.1.0] - 2025-02-17
### Added
- Added code generator for pubspec metadata
  - is disabled by default but can be enabled per project
...
- Updated dependencies
- Updated linter rules with new rules for dart 3.7

## [6.0.2+2] - 2025-02-01
### Fixed
- Revert workaround for minisign on windows

## [6.0.2+1] - 2025-01-26
### Fixed
- Applied workaround for minisign on windows (See https://github.com/ScoopInstaller/Main/pull/6461)
...
[7.2.1]: https://github.com/Skycoder42/dart_test_tools/compare/v7.2.0...v7.2.1
[7.2.0]: https://github.com/Skycoder42/dart_test_tools/compare/v7.1.2...v7.2.0
[7.1.2]: https://github.com/Skycoder42/dart_test_tools/compare/v7.1.1...v7.1.2
[7.1.1]: https://github.com/Skycoder42/dart_test_tools/compare/v7.1.0...v7.1.1
[7.1.0]: https://github.com/Skycoder42/dart_test_tools/compare/v7.0.3...v7.1.0
[7.0.3]: https://github.com/Skycoder42/dart_test_tools/compare/v7.0.2+1...v7.0.3
...
[6.0.3]: https://github.com/Skycoder42/dart_test_tools/compare/v6.0.2+2...v6.0.3
[6.0.2+2]: https://github.com/Skycoder42/dart_test_tools/compare/v6.0.2+1...v6.0.2+2
[6.0.2+1]: https://github.com/Skycoder42/dart_test_tools/compare/v6.0.2...v6.0.2+1
