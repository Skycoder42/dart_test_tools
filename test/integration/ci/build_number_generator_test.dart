...
final class _TestOverrides(final Directory testDir) extends IOOverrides {
  @override
...
''');
        ...
        final output = await File(Platform.environment['GITHUB_OUTPUT']!)
            .readAsLines();
...
''');
        ...
        final output = await File(Platform.environment['GITHUB_ENV']!)
            .readAsLines();
