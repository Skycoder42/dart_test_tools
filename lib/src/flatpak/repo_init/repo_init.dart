...
class const RepoInit([
  final MetadataCollector _metadataCollector = const MetadataCollector(),
  final RepoGenerator _repoGenerator = const RepoGenerator(),
  final RepoFileGenerator _repoFileGenerator = const RepoFileGenerator(),
]) {
  Future<void> call({
