...
| Skill | Purpose |
| --- | --- |
| `dart-test-tools-auto-update` | Run a new dependency update, or pick up the one open on `automatic-dependency-updates`, then validate the package the way CI does. |
