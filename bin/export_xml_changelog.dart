  ...
  final parser =
      ArgParser(
        ...
        ..addFlag(
          ...
          defaultsTo: true,
          help:
              'Assumes the target file is a metainfo.xml file. '
              'In this case, the changelog is written as a child element of '
              'the component. Otherwise the file is overwritten as standalone '
