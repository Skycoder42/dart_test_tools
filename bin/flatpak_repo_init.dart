...
Future<void> main(List<String> args) async {
  final parser = ArgParser(
    ...
    ..addOption(
      ...
      abbr: 'r',
      valueHelp: 'path',
      help: 'Path to the repository that should be initialized. '
    ...
    ..addFlag(
      'update',
      abbr: 'U',
      help: 'Update configuration of an existing repository '
    ...
    ..addOption(
      ...
      abbr: 'm',
      valueHelp: 'path',
      help: 'Path to the metainfo.xml to generate the flatpakrepo file from.',
      mandatory: true,
    )
    ..addOption(
      'icon',
