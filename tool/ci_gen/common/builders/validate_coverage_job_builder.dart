...
''',
          ...
          Step.uses(
            ...
            withArgs: {
              'name': 'coverage-html',
              'path':
                  '${Expression.input(workingDirectoryInput)}/coverage/html',
            },
          ),
          Step.uses(
            ...
            withArgs: {
              'path':
                  '${Expression.input(workingDirectoryInput)}/coverage/cleaned.info',
  ...
  Step _createCoverageDownloadStep(String platform) => Step.uses(
        ...
        withArgs: {
          ...
          'path':
              '${Expression.input(workingDirectoryInput)}/coverage/$platform',
        },
      );
}
